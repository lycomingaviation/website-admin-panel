...
const GalleryManagement: React.FC<any> = () => {
  ...
  const fetchProduct = async () => {
    ...
    try {
      const response = await apiRequest("POST", "gallerySelect.php", payload);
  ...
  const handleDelete = async (id: any) => {
    try {
      const response = await apiRequest("POST", "galleryDelete.php", { id });
      if (response.success) {
